...
@WebServlet("/ServletSearcbDelete")
public class ServletSearcbDelete extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String referer = request.getHeader("referer");
            ...
            if (lisearch.isEmpty()){
                ...
                request.getRequestDispatcher("/searchBookdelete.jsp").forward(request,response);
            }
